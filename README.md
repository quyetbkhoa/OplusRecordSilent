...
- **Tự động đổi tên file ghi âm VoIP**: Tích hợp daemon chạy ngầm tự động theo dõi tên người gọi từ thông báo VoIP đang diễn ra và tự động đổi tên file sau khi kết thúc cuộc gọi (~2s) sang định dạng `[AppName]_[CallerName]_[DD.MM.YYYY]_[HH]h[mm].aac` (ví dụ: `Messenger_Bố_20.09.2026_08h08.aac`), đồng bộ tức thì vào ứng dụng Ghi âm hệ thống.
